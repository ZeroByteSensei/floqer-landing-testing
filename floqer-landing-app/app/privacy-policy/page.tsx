...
export const metadata: Metadata = {
  title: 'Floqer | Privacy Policy',
  description: 'Floqer Privacy Policy',
};
const Page = () => {
  return (
    <>
      <Head>
        <title>Floqer | Privacy Policy</title>
        <meta name="description" content="Floqer's privacy policy" />
      </Head>
      <div className="flex p-4 gap-4 flex-col !text-lg">
        <h1 className="font-semibold text-6xl text-primary">Privacy Policy</h1>
          ...
          <ul className="list-disc ml-4">
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Aftermath Labs Inc., 1333 South Park
                Street, Halifax, NS.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: Nova Scotia, Canada
              </p>
            </li>
            <li>
              <p>
        ...
        <section className="flex flex-col gap-4 p-4">
          <h2 className="text-4xl font-semibold">Children&apos;s Privacy</h2>
          <p>
        ...
        <section className="flex flex-col gap-4 p-4">
          <h2 className="text-4xl font-semibold">Links to Other Websites</h2>
          <p>
        ...
        <section className="flex flex-col gap-4 p-4">
          ...
          <ul className="list-disc ml-4">
            ...
            <li>
              <p>By phone number: 902.880.1937</p>
            </li>
          </ul>
        </section>
      </div>
